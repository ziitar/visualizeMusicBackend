...
import { encode as base64Encode } from "https://deno.land/std@0.184.0/encoding/base64.ts";
import * as B from "https://deno.land/x/bigint@v0.3/mod.ts";
import { encode as hexEncode } from "https://deno.land/std@0.184.0/encoding/hex.ts";
...
export function rsaEncrypt(text, pubKey, modulus) {
  ...
  const biText = BigInt(
      `0x${textDecoder.decode(hexEncode(textEncoder.encode(_text)))}`
    ),
